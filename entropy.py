...
def parse_args():
    ...
    parser.add_argument('-sd', '--save_data', type=str, default=True)
...
def evaluation():
    ...
    if args.save_data:
        utils.numpy_save(all_value, args.weights, 'data')

    avg_val_loss = val_loss / len(train_loader.dataset)
    avg_val_acc = val_acc / len(train_loader.dataset)
    print()
...
if __name__ == '__main__':
    ...
    train_loader, test_loader = dataset_loader(dataset=args.dataset, train_batch=args.train_batch, test_batch=args.test_batch)
