...
def evaluation(epoch, train_loss):
    val_loss = 0
    val_acc = 0
    model.eval()
    with torch.no_grad():
    ...
    if args.writer:
        ...
        writer.add_scalar('Test/Accuracy', avg_val_acc, epoch)
...
if __name__ == '__main__':
    ...
    train_loader, test_loader = dataset_loader(args.dataset, args.train_batch,
                                               args.test_batch,
                                               args.num_worker)
    ...
    for epoch in range(args.num_epochs):
        ...
        # # evaluation
        val_acc = evaluation(epoch, train_loss)
    ...
    if args.csv:
        ...
        utils.csv_write(csvfile, model_name, acc_max,args.train_batch,args.test_batch,args.num_worker,args.num_epochs,args.lr,
        args.step_size,args.gamma,args.fixed_num)
